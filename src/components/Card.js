...
const Card = ({ userData }) => {
  const date = moment(userData.created_at).format("MMM Do YYYY");
    ...
    <div className="card-container">
      ...
      <div className="card-content-container">
        <div className="card-header">
          ...
          <span className="card-date">Joined {date}</span>
        </div>
        ...
        <div className="card-info-container-1">
          <div>
            Repos{" "}
            <p>
              <strong className="info-container-1">
          ...
          <div>
            Followers{" "}
            <p>
              <strong className="info-container-1">{userData.followers}</strong>
            </p>
          </div>
          <div>
            Following{" "}
        ...
        <div className="card-info-container-2">
          <div className="location-blog">
            <p>
              <span className="location-blog-span-1">
              ...
              {userData.location ? (
                ...
                <span className="opacity">Not Available</span>
              )}
            </p>
            <p>
              <span className="location-blog-span-2">
          ...
          <div className="twitter-company">
            <p>
              <span className="twitter-company-span-1">
            ...
            <p>
              <span className="twitter-company-span-2">
                <svg height="20" width="20" xmlns="http://www.w3.org/2000/svg">
                  <g>
