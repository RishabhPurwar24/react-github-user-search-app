...
const Header = ({ theme, switchThemeHandler }) => {
  return (
    <div className="header">
      <h1 className="heading">devfinder</h1>
      <button className="toggle-button" onClick={switchThemeHandler}>
        {theme === "dark" ? (
          <>
            <span className="light-button">LIGHT</span>
            <svg
              className="sun"
              width="20"
              height="20"
          ...
          <>
            <span className="light-button">DARK</span>
